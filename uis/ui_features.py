...
class Ui_Features(object):
    def setupUi(self, Features):
        ...
        self.frame_spectrals.setGeometry(QtCore.QRect(50, 350, 191, 224))
        ...
        self.frame_textures.setGeometry(QtCore.QRect(280, 350, 128, 172))
        ...
        self.lineEdit_output.setGeometry(QtCore.QRect(50, 260, 261, 27))
        ...
        self.lineEdit_field.setGeometry(QtCore.QRect(100, 310, 171, 27))
        self.lineEdit_field.setObjectName(_fromUtf8("lineEdit_field"))
        self.label_id = QtGui.QLabel(Features)
        self.label_id.setGeometry(QtCore.QRect(50, 320, 51, 17))
        ...
        self.checkBox_multiprocess = QtGui.QCheckBox(Features)
        self.checkBox_multiprocess.setGeometry(QtCore.QRect(310, 310, 101, 20))
        self.checkBox_multiprocess.setObjectName(_fromUtf8("checkBox_multiprocess"))
        self.comboBox_input = QtGui.QComboBox(Features)
        self.comboBox_input.setGeometry(QtCore.QRect(50, 150, 361, 20))
        self.comboBox_input.setObjectName(_fromUtf8("comboBox_input"))
        self.comboBox_input.addItem(_fromUtf8(""))
        self.comboBox_training = QtGui.QComboBox(Features)
        self.comboBox_training.setGeometry(QtCore.QRect(50, 210, 361, 20))
    ...
    def retranslateUi(self, Features):
        ...
        self.checkBox_weighbr.setText(_translate("Features", "Weight BR", None))
        ...
        self.checkBox_multiprocess.setText(_translate("Features", "Multiprocess", None))
        self.comboBox_input.setItemText(0, _translate("Features", "[Choose from a file..]", "Click to select File"))
        self.comboBox_training.setItemText(0, _translate("Features", "[Choose from a file..]", "Click to select File"))
