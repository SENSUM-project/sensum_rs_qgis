...
#
# Created: Fri Jun  6 09:45:39 2014
...
class Ui_Features(object):
    def setupUi(self, Features):
        ...
        self.frame_textures.setGeometry(QtCore.QRect(230, 260, 128, 172))
    ...
    def retranslateUi(self, Features):
        ...
        self.checkBox_maxbr.setText(_translate("Features", "Max BR", None))
        self.checkBox_mean.setText(_translate("Features", "Mean", None))
        self.checkBox_minbr.setText(_translate("Features", "Min BR", None))
        self.checkBox_mode.setText(_translate("Features", "Mode", None))
        self.checkBox_ndivistd.setText(_translate("Features", "Ndvi std", None))
        self.checkBox_ndvimean.setText(_translate("Features", "Ndvi mean", None))
        self.checkBox_std.setText(_translate("Features", "Std", None))
