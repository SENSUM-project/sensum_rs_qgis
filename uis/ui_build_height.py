...
class Ui_BuildHeight(object):
    def setupUi(self, BuildHeight):
        ...
        self.label_4.setGeometry(QtCore.QRect(40, 300, 201, 16))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.label_5 = QtGui.QLabel(BuildHeight)
        self.label_5.setGeometry(QtCore.QRect(60, 360, 121, 17))
        ...
        self.comboBox_input_buildings = QtGui.QComboBox(BuildHeight)
        self.comboBox_input_buildings.setGeometry(QtCore.QRect(30, 150, 411, 20))
        self.comboBox_input_buildings.setObjectName(_fromUtf8("comboBox_input_buildings"))
        self.comboBox_input_buildings.addItem(_fromUtf8(""))
        self.comboBox_input_shadows = QtGui.QComboBox(BuildHeight)
        self.comboBox_input_shadows.setGeometry(QtCore.QRect(30, 200, 411, 20))
        self.comboBox_input_shadows.setObjectName(_fromUtf8("comboBox_input_shadows"))
        self.comboBox_input_shadows.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, BuildHeight):
        ...
        self.label.setText(_translate("BuildHeight", "Buildings ESRI Shapefile", None))
        ...
        self.comboBox_input_buildings.setItemText(0, _translate("BuildHeight", "[Choose from a file..]", "Click to select File"))
        self.comboBox_input_shadows.setItemText(0, _translate("BuildHeight", "[Choose from a file..]", "Click to select File"))
