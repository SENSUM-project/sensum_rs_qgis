...
class Ui_Footprints(object):
    def setupUi(self, Footprints):
        ...
        self.label_pansharp.setGeometry(QtCore.QRect(70, 130, 161, 16))
        self.label_pansharp.setObjectName(_fromUtf8("label_pansharp"))
        self.label_training = QtGui.QLabel(Footprints)
        self.label_training.setGeometry(QtCore.QRect(70, 190, 121, 16))
        ...
        self.label_title.setGeometry(QtCore.QRect(110, 100, 261, 21))
        ...
        self.label_output.setGeometry(QtCore.QRect(70, 250, 191, 16))
        ...
        self.lineEdit_classes = QtGui.QSpinBox(Footprints)
        self.lineEdit_classes.setGeometry(QtCore.QRect(90, 480, 181, 22))
        self.lineEdit_classes.setObjectName(_fromUtf8("lineEdit_classes"))
        self.comboBox_pansharp = QtGui.QComboBox(Footprints)
        self.comboBox_pansharp.setGeometry(QtCore.QRect(70, 150, 331, 20))
        self.comboBox_pansharp.setObjectName(_fromUtf8("comboBox_pansharp"))
        self.comboBox_pansharp.addItem(_fromUtf8(""))
        self.comboBox_training = QtGui.QComboBox(Footprints)
        self.comboBox_training.setGeometry(QtCore.QRect(70, 210, 331, 20))
        self.comboBox_training.setObjectName(_fromUtf8("comboBox_training"))
        self.comboBox_training.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, Footprints):
        ...
        self.label_pansharp.setText(_translate("Footprints", "Pansharpened Image", None))
        self.label_training.setText(_translate("Footprints", "Training Set", None))
        ...
        self.label_title.setText(_translate("Footprints", "<html><head/><body><p><span style=\" font-size:16pt;\">BUILDINGS EXTRACTION</span></p></body></html>", None))
        ...
        self.label_output.setText(_translate("Footprints", "Output ESRI Shapefile", None))
        self.comboBox_pansharp.setItemText(0, _translate("Footprints", "[Choose from a file..]", "Click to select File"))
        self.comboBox_training.setItemText(0, _translate("Footprints", "[Choose from a file..]", "Click to select File"))
